...
public class CustomWindows {
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(CustomWindows.class);
    ...
    static class WindowByValueElement
            extends WindowFn<KV<String, Integer>, @NonNull IntervalWindow> {
