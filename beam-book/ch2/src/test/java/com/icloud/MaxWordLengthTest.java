...
public class MaxWordLengthTest {
  ...
  public void testWordLength() {
    ...
    final PCollection<String> output =
        MaxWordLength.computeLongestWord(strings)
            .apply(
                "Convert To KV",
                MapElements.into(strings()).via(kv -> kv.getTimestamp() + ":" + kv.getValue()))
    ...
    PAssert.that(output).inFinalPane(GlobalWindow.INSTANCE).empty();
