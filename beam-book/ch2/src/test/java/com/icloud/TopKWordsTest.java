...
public class TopKWordsTest {
    ...
    public void test() {
        ...
        final IntervalWindow secondWindow =
                new IntervalWindow(startOfTenSecondWindow.plus(windowDuration), startOfTenSecondWindow.plus(windowDuration).plus(windowDuration));
        ...
        return TestStream.create(StringUtf8Coder.of())
                .addElements(
                        ...
                        timestampedValue(
                                ...
                                baseTime.plus(10_000)
                        ),
                        timestampedValue("Last line, in the same window as previous line.", baseTime.plus(11_000))
                )
