...
public class ViewExample {
  public static void main(String[] args) {
    ...
    final PCollection<KV<String, String>> citiesToCountries =
        pipeline.apply(
    ...
    final PCollection<KV<String, String>> persons =
        pipeline.apply(
            "Persons",
            Create.of(
    ...
    final PCollectionView<Map<String, String>> citiesToCountriesView =
        citiesToCountries.apply(Latest.perKey()).apply(View.asMap());

    final PCollection<KV<String, String>> output =
        persons.apply(
            ParDo.of(
                ...
                .withSideInputs(Map.of("cities-countries", citiesToCountriesView)));
