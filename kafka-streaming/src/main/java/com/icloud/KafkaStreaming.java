...
public class KafkaStreaming {
  ...
  public static void main(String[] args) {
    ...
    final KafkaStreamingOptions options = createOption(args, KafkaStreamingOptions.class);
  ...
  static class KafkaConsumer {
      ...
      pCollection
          .apply(
              Window.<KV<String, Integer>>into(
                      FixedWindows.of(Duration.standardSeconds(WINDOW_TIME)))
                  .triggering(
                      Repeatedly.forever(
                          AfterProcessingTime.pastFirstElementInPane()
                              .plusDelayOf(
                                  Duration.standardSeconds(TIME_OUTPUT_AFTER_FIRST_ELEMENT))))
    ...
    static class WindowCombineFn
      ...
      @Override
      public Map<String, Integer> addInput(Map<String, Integer> accum, KV<String, Integer> input) {
      ...
      @Override
      public Map<String, Integer> mergeAccumulators(Iterable<Map<String, Integer>> accums) {
      ...
      @Override
      public Map<String, Integer> extractOutput(Map<String, Integer> accum) {
        return accum;
      }
    }
  }

  static class KafkaProducer extends TimerTask {
    ...
    public void run() {
      ...
      final PCollection<KV<String, Integer>> input =
          pipeline
              .apply(
    ...
    @SuppressWarnings("unused")
    static class RandomUserScoreGenFn extends DoFn<Long, KV<String, Integer>> {
  ...
  static class LogErrors
    ...
    static class LogErrorFn extends DoFn<BadRecord, BadRecord> {
      ...
      private final Counter badRecordCounter = Metrics.counter(getClass(), "bad record counter");

      @ProcessElement
      public void process(@Element BadRecord record, OutputReceiver<BadRecord> output) {
