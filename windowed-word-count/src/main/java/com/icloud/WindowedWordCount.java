...
public class WindowedWordCount {
  ...
  public static void runWindowedWordCount(Options options) throws IOException {
    ...
    final PCollection<KV<String, Long>> wordCounts = windowedWords.apply(CountWords.of());
  ...
  public interface Options extends WordCountOptions, ExampleOptions, ExampleBigQueryTableOptions {
  ...
  private static class AddTimestampFn extends DoFn<String, String> {
    ...
    @ProcessElement
    public void process(@Element String line, OutputReceiver<String> output) {
      final Instant randomTimestamp =
          new Instant(
